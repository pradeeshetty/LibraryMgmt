...
<body>
	...
	<label for="field2"><span>Year <span class="required">*</span></span><input type="number" id="yr" class="input-field" name="year" min="1900" max="2019" maxlength="4" title="Year should have only 4 digit" required /></label>
	<label for="field4"><span>No of Copies</span><select name="copies" class="select-field" required>
