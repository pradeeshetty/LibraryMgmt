    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
            	...
            	<table>
            	<tr><th>Email:</th><th>User Name:</th> <th>Book Name:</th> 
            	</tr>
            	
            	<%
            	DbConnection d=new DbConnection();
            	List l=d.getissuedbooks();
            	String id="";
              ...
              <td>   <%=iterator.next() %></td>
               ...
               <% //iterator.next(); %> 
                 ...
                 <td> <a href="BookReturn?bookid=<%=iterator.next() %>&issueid=<%=iterator.next() %>">Return</a></td>
                 <%--  <td> <a href="RejectBook?bookid=<%=iterator.next() %>">Reject</a></td> --%>
